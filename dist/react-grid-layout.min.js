      ...
      (function(t, n) {
        ...
        (Yt["[object Float32Array]"] = Yt["[object Float64Array]"] = Yt[
          ...
          (Yt[St] = Yt[_t] = Yt[It] = Yt[Rt] = Yt[Bt] = Yt[Dt] = Yt[jt] = Yt[
            Et
          ] = Yt[Tt] = Yt[Ct] = Yt[kt] = Yt[Lt] = Yt[Nt] = Yt[At] = Yt[
            "[object WeakMap]"
          ] = !1);
        ...
        (f.prototype.clear = p),
          ...
          (_.prototype.has = j),
          (_.prototype.set = E),
          (z.prototype.add = z.prototype.push = T),
          (z.prototype.has = C),
          (P.prototype.clear = k),
    ...
    function(t, e, n) {
      ...
      (b.displayName = "ReactGridLayout"),
        (b.propTypes = {
          ...
          resizableAxis: f.default.string,
          ...
          return (
            ...
            (e.prototype.mixinResizable = function(t, e) {
              var n = this.props,
                ...
                u = n.maxH,
                c = n.resizableAxis,
                f = this.calcPosition(0, 0, r - o, 0).width,
                p = this.calcPosition(0, 0, a, i),
                h = this.calcPosition(0, 0, s, u),
                y = [p.width, p.height],
                g = [Math.min(h.width, f), Math.min(h.height, 1 / 0)];
              return l.default.createElement(
                d.Resizable,
                {
                  width: e.width,
